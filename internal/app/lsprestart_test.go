...
// Every test here depends on newTestApp pinning lspLookPath at "never
// found": the restart verb ends in a real spawn when a binary resolves,
// and none of them may start the machine's own gopls.
