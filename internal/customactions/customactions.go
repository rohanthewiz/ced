...
// ~/.config/ced/actions.json and exposes them to the editor's
...
// $XDG_CONFIG_HOME/ced/actions.json, falling back to
// ~/.config/ced/actions.json when XDG_CONFIG_HOME isn't set.
...
func DefaultPath() string {
	if xdg := os.Getenv("XDG_CONFIG_HOME"); xdg != "" {
		return filepath.Join(xdg, "ced", "actions.json")
	}
	home, err := os.UserHomeDir()
	if err != nil || home == "" {
		return ""
	}
	return filepath.Join(home, ".config", "ced", "actions.json")
}
...
// $XDG_STATE_HOME/ced/actions.log, falling back to
// ~/.local/state/ced/actions.log when XDG_STATE_HOME isn't set.
...
func LogPath() string {
	if xdg := os.Getenv("XDG_STATE_HOME"); xdg != "" {
		return filepath.Join(xdg, "ced", "actions.log")
	}
	home, err := os.UserHomeDir()
	if err != nil || home == "" {
		return ""
	}
	return filepath.Join(home, ".local", "state", "ced", "actions.log")
}
