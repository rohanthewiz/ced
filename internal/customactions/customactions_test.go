...
func TestDefaultPath_PrefersXDG(t *testing.T) {
	...
	got := DefaultPath()
	want := filepath.Join("/tmp/xdgtest", "ced", "actions.json")
	if got != want {
...
func TestDefaultPath_FallsBackToHome(t *testing.T) {
	...
	got := DefaultPath()
	want := filepath.Join("/Users/test", ".config", "ced", "actions.json")
	if got != want {
		t.Fatalf("DefaultPath = %q, want %q", got, want)
	}
}
...
func TestLogPath_PrefersXDGState(t *testing.T) {
	...
	got := LogPath()
	want := filepath.Join("/tmp/xdgstate", "ced", "actions.log")
	if got != want {
...
// log lives under ~/.local/state/ced/.
func TestLogPath_FallsBackToHome(t *testing.T) {
	t.Setenv("XDG_STATE_HOME", "")
	t.Setenv("HOME", "/Users/test")
	got := LogPath()
	want := filepath.Join("/Users/test", ".local", "state", "ced", "actions.log")
	if got != want {
		t.Fatalf("LogPath = %q, want %q", got, want)
	}
}
